...
def add_item(shopping_list, products, item_id):
    for product in products:
        if product['id'] == item_id:
            shopping_list.append(product)
            print(f"Added '{product['title']}' to the shopping list.")
            return
...
def main():
    ...
    while True:
        ...
        if choice == "1":
            item_id = get_int_input("Enter the ID of the product you want to add: ")
            add_item(shopping_list, products, item_id)
        elif choice == "2":
            item_id = get_int_input("Enter the ID of the product you want to remove: ")
            remove_item(shopping_list, item_id)
        elif choice == "3":
            print("Shopping List:")
